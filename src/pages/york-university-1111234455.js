...
const carouselData = [
  ...
  {
    text: `<h1 class="text-2xl font-thin margin-bottom-125 tracking-wide text-center text-gray-700 uppercase">
    KASHMIR: I Hope They Serve Beer In Hell — A Lost Childhood
    </h1>`,
  },
  {
    text: `
  ...
  imageObjectBuilder.buildImage({
    imgName: "2. Cemetery.jpg",
    caption: "Cemetery",
  }),
  imageObjectBuilder.buildImage({
    imgName: "3. XRay Portraits of Pellet Victims_york.jpg",
    ...
    <Layout rootClass="submission">
      ...
      <div className="flex justify-center">
        <a
          ...
          href="/Anita Khemka_Portfolio Submission-york-20191119T154141Z-001.zip"
          download
        >
